...
for dataNum in os.listdir('{}/minion_data/INI/'.format(configDir)):#   
    if dataNum.endswith('_TEMPPRESOXY-INI.txt'):
...
file_name = "{}/minion_data/INI/{}_TEMPPRESOXY-INI.txt".format(configDir, samp_time)
...
file.write("{}_TEMPPRESOXY.txt ".format(samp_time))
...
#    if iniO2 == True:
#        os.system('sudo python3 /home/pi/Documents/Minion_scripts/OXYBASE_RS232_IF_MMOdev.py &')
#        print("Started running OXY MMO script")
#    if iniAcc == True:
...
#        tic = time.perf_counter()
            ...
            print("Initial Sampling Mode, on sample " + str(NumSamples) + " of " + str(TotalSamples))  #Indicate to the user in which mode the Minion is operating
            ...
            if iniO2 == True:
                ...
                sensor_string = '{}, {}'.format(sensor_string, reply)
                sensor_string = sensor_string.replace('b', '', 1)
